...
FACT_WORDS = ["Efrei","immersion","","cybersecurité", "big data", "L3", "prepa scientifique", "prepa bio", "prepa section "] 
...
COMMENTS_ABOUT_SELF = ["I know more about Efrei than you.",
                        "I'm doing my best"]

NONE_RESPONSES = [ "What can I help you with?",
                    "Ask me about Efrei Paris !",
                    "What do you want to know about Efrei Paris ?"]
...
def main():
    ...
    while running:
        if not known_user:
            user_name = input("> Hello I'm a Efrei bot. Whats your name? ")
