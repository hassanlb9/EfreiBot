...
def fact_curator():
    ...
    topics = ["Efrei","immersion","","cybersecurité", "big data", "L3", "prepa scientifique", "prepa bio", "prepa section "] 
    filename = "facts.txt"
...
def knowledge_base_creator():
    ...
    # Words related to efrei bot
    fact_words = ["cybersecurité", "big data", "L3", "prepa scientifique", "prepa bio", "prepa section "]    
